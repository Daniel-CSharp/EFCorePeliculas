...
namespace EFCorePeliculas.Entidades.Seeding
{
    public static class SeedingModuloConsulta
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            ...
            var tomHolland = new Actor() { Id = 1, Nombre = "Tom", Apellido = "Holland", FechaNacimiento = new DateTime(1996, 6, 1), Biografia = "Thomas Stanley Holland (Kingston upon Thames, Londres; 1 de junio de 1996), conocido simplemente como Tom Holland, es un actor, actor de voz y bailarín británico." };
            var samuelJackson = new Actor() { Id = 2, Nombre = "Samuel", Apellido = "Jackson", FechaNacimiento = new DateTime(1948, 12, 21), Biografia = "Samuel Leroy Jackson (Washington D. C., 21 de diciembre de 1948), conocido como Samuel L. Jackson, es un actor y productor de cine, televisión y teatro estadounidense. Ha sido candidato al premio Óscar, a los Globos de Oro y al Premio del Sindicato de Actores, así como ganador de un BAFTA al mejor actor de reparto." };
            var robertDowney = new Actor() { Id = 3, Nombre = "Robert", Apellido = "Downey Jr", FechaNacimiento = new DateTime(1965, 4, 4), Biografia = "Robert John Downey Jr. (Nueva York, 4 de abril de 1965) es un actor, actor de voz, productor y cantante estadounidense. Inició su carrera como actor a temprana edad apareciendo en varios filmes dirigidos por su padre, Robert Downey Sr., y en su infancia estudió actuación en varias academias de Nueva York." };
            var chrisEvans = new Actor() { Id = 4, Nombre = "Chris", Apellido = "Evans", FechaNacimiento = new DateTime(1981, 06, 13) };
            var laRoca = new Actor() { Id = 5, Nombre = "Dwayne", Apellido = "Johnson", FechaNacimiento = new DateTime(1972, 5, 2) };
            var auliCravalho = new Actor() { Id = 6, Nombre = "Auli'i", Apellido = "Cravalho", FechaNacimiento = new DateTime(2000, 11, 22) };
            var scarlettJohansson = new Actor() { Id = 7, Nombre = "Scarlett", Apellido = "Johansson", FechaNacimiento = new DateTime(1984, 11, 22) };
            var keanuReeves = new Actor() { Id = 8, Nombre = "Keanu", Apellido = "Reeves", FechaNacimiento = new DateTime(1964, 9, 2) };
